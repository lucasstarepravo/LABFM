from functions.discrete_operator import calc_l2, calc_l2_sph
...
from functions.test_function import test_function, dif_analytical, laplace_phi, dif_do, deriv_sph, lap_sph


class TestFunction:
    def __init__(self, coordinates, labfm_w, sph_w):
...
class Simulation:
    def __init__(self, total_nodes, polynomial):
        ...
        self.test_function  = TestFunction(self.coordinates, self.labfm_w  , self.sph_w)
